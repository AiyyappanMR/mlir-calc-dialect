...
namespace
{ // class converter will be implemented here
template <typename CalcOp, typename tosaOp> class convertElemWiseOp : public mlir::OpRewritePattern<CalcOp>
{
...
namespace
{
template <typename CalcOp, typename tosaOp> class covertMulElementWiseOp : public mlir::OpRewritePattern<CalcOp>
{
    using mlir::OpRewritePattern<CalcOp>::OpRewritePattern;
...
class convertAddcmulOp : public mlir::OpRewritePattern<calc::addcmulOp>
{
    ...
    mlir::LogicalResult matchAndRewrite(calc::addcmulOp op, mlir::PatternRewriter &rewriter) const override
    {
        ...
        mlir::Value tensor_out_1 =
            mlir::tosa::MulOp::create(rewriter, op.getLoc(), resultType, tensor1, tensor2, shift);
        ...
        if (valueAttr)
        {
            ...
            mlir::Value tensor_out_2 =
                mlir::tosa::MulOp::create(rewriter, op.getLoc(), resultType, tensor_out_1, valueTensor, shift);
